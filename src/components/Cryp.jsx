...
export default function Cryp() {
  ...
  return (
    ...
    >
      ...
      {load === true ? (
        <Box align="center" height="75vh" mt="25vh">
        ...
        <Box height="90%"pt={["10vh", "6%"]} pb="2%" align="center">
          <HStack
            ...
            bg="gray.900"
          >
            <Box ml="5%" display={["none", "", "", "block"]} color="white">
              Rank
            </Box>
            <Box pl={["9%", "5%"]} color="white">
              Name
            </Box>
            <Box pl={["25%", "20%"]} color="white">
              Current Price
            </Box>
            <Box pl={["10%", "3%"]} color="white">
              24h %
            </Box>
            <Box pl="5%" display={["none", "", "", "block"]} color="white">
              Market Cap
            </Box>
            <Box pl="8%" display={["none", "", "", "block"]} color="white">
              Circulating Supply
            </Box>
          </HStack>
          {price.map((p) => (
